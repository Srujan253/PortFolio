  ...
  return (
    <footer className="glass py-8 mt-24 text-center flex flex-col items-center gap-4">
      <div className="flex gap-8 mb-2">
        ...
        <a href="https://www.linkedin.com/in/srujan-h-m-a51940321" target="_blank" rel="noopener noreferrer" className="text-3xl text-gray-700 dark:text-gray-200 hover:text-cyan-400 transition-colors"><FaLinkedin /></a>
